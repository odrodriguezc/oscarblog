...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('input[name="email"]').addEventListener('keydown', cancelSubmit);
